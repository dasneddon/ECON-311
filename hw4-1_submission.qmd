...
```{r}
library(scales)
plot(x = round(wine$alcohol, 1), 
     y = wine$quality,
     xlab = "Alcohol Content",
     ylab = "Quality Rating",
     pch = 16,
     col = ifelse(wine$red==1, alpha("red",0.3), alpha("green",0.1)),
     las = 1,
     main = "Quality Rating by Alcohol Content",
     bty = "l"
     )
legend("bottomright", 
...
First, there are far more observations of white wine than red wine. Roughly triple so I tried to compensate by making the alpha for red wine triple the alpha for red wine, but red wine appears to still get lost with the white wine wine. In spite of this, I would say that there is a modest positive correlation between alcohol content and the quality rating and there may be more variance in the red wine and white. 
